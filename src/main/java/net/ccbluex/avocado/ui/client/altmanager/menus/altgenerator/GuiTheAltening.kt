 ...
 */
package net.ccbluex.avocado.ui.client.altmanager.menus.altgenerator
...
import net.ccbluex.avocado.ui.elements.GuiPasswordField
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        assumeNonVolatile {
            ...
            Fonts.fontSemibold40.drawCenteredString(
                "§7Use coupon code 'avocado' for 20% off!",
                width / 2f,
                height / 2 + 55f,
                0xffffff
            )
