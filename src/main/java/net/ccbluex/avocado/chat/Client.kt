 ...
 */
package net.ccbluex.avocado.chat
...
import net.ccbluex.avocado.chat.packet.PacketDeserializer
import net.ccbluex.avocado.chat.packet.PacketSerializer
import net.ccbluex.avocado.chat.packet.packets.*
...
abstract class Client : ClientListener, MinecraftInstance {
    ...
    fun connect() {
        ...
        val uri = URI("wss://chat.avocado.net:7886/ws")
